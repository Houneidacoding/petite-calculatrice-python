...
## Évolutions par rapport à la versoion 3
  - Structuration uniforme des données retournées par les fonctions 
  - Stockage structuré des opérations dans une liste
  - Amélioration de l'affichage de l'historique 
  - Gestion propre des angles en degrés pour les fonctions trigonométriques
...
- calculatrice_V4.py : affichage plus lisible de l'historique (nombre1 Opération nombre2 = Resultat) Exemple: // 25.0 + 36.0 = 61.0 // √ 854.0 = 29.22 // ( 8.0 )²= 64.0 // sin ( 45.6 °)= 0.71
